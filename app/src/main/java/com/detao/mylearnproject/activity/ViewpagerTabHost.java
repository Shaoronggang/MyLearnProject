...
import com.detao.mylearnproject.adapter.MyPagerAdapter;
import com.detao.mylearnproject.base.BaseActivity;

import java.util.ArrayList;

/**
 * Created by shaoronggang on 2017/5/16.
 */

public class ViewpagerTabHost extends BaseActivity
        implements View.OnClickListener,
        ViewPager.OnPageChangeListener {
    @Override
    protected int getResLayout() {
        return R.layout.tabhostactivity;
    }
    ...
    private void initViews() {
        ...
        Matrix matrix = new Matrix();   //用来设置相应的位置
        matrix.postTranslate(offset,0);
        img_cursor.setImageMatrix(matrix); //设置动画初始化位置
        ...
        two = one * 2; //移动两页的偏移量，比如1直接跳3
            ...
            listViews.add(mInflater.inflate(R.layout.viewone, null, false));
            listViews.add(mInflater.inflate(R.layout.viewtwo, null, false));
            listViews.add(mInflater.inflate(R.layout.viewthree, null, false));
